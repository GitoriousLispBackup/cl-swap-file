...
(define-test find-open-disk-block
  (let ((swap-file (swap-file::make-swap-file  :version 1 :block-size 128 :available-list 0 :stream (binary-file:make-binary-array-io-stream)
                                               :open-blocks (list (swap-file::make-disk-block :offset 123)
                                                                  (swap-file::make-disk-block :offset 234)))))
    (assert-eql 123 (swap-file::disk-block-offset (swap-file::find-open-disk-block swap-file 123)))
    (assert-eql 234 (swap-file::disk-block-offset (swap-file::find-open-disk-block swap-file 234)))
    (assert-false (swap-file::find-open-disk-block swap-file 567))))
  
(define-test get-from-cache 
  (let ((swap-file (swap-file::make-swap-file  :version 1 :block-size 128 :available-list 0 :stream (binary-file:make-binary-array-io-stream)))
        (disk-block (swap-file::make-disk-block :offset 123)))
    (swap-file::push-to-cache swap-file disk-block)
    (assert-eq disk-block (swap-file::get-from-cache swap-file 123))
    (assert-false (swap-file::get-from-cache swap-file 567))))
